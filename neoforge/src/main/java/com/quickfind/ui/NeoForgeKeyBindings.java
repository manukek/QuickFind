...
public final class NeoForgeKeyBindings {
    private static final KeyMapping FOCUS_SEARCH = new KeyMapping("key.quickfind.focus_search", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_F, KeyMapping.Category.INVENTORY);
